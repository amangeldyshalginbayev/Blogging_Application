...
from flaskblog.users.forms import (RegistrationForm, LoginForm,
                                   ...
                                   ResetPasswordForm, MobilePhoneEntryForm,
...
def login():
    ...
    if form.validate_on_submit():
        ...
        if user and bcrypt.check_password_hash(user.password,
            ...
            send_activation_email(user)
            flash(
                'You need to activate your account to login. Activation link '
                'has been sent to your email', 'danger')
        else:
...
def link_mobile_phone():
    ...
    if form.validate_on_submit():
        ...
        if pin_code:
            ...
            flash(
                'We were not able to deliver sms to you. Please try '
                'again later.', 'danger')
